...
//this function parses data from the temps.txt file. It's called from the updateChart funtion.
var get_temp = function () {
  ...
  for (var j = 0; j < count; j++) {
        var xVal = new Date();
    get_temp(); //get_temp function is called
    yVal = temp_c;
...
setInterval(function(){updateChart()}, updateInterval); //runs updateChart funtion on specified intervals
